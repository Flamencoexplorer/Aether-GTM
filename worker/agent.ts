...
/**
 * GtmAgent - A new Durable Object for specialized GTM agent logic.
 * This will be expanded in future phases.
 */
interface GtmAgentState {
    id: string;
    role: string;
    status: 'idle' | 'working' | 'error';
}
export class GtmAgent extends Agent<Env, GtmAgentState> {
    initialState: GtmAgentState = {
        id: '',
        role: 'Unassigned',
        status: 'idle',
    };
    async onStart(): Promise<void> {
        console.log(`GTM Agent ${this.name} started.`);
